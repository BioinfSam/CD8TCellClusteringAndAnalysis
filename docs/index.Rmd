...
setwd("/Users/sam/Documents/GitHub/GenericIntegrationAndClustering/docs/")
```
...
p1 <- DimPlot(my.seurat, reduction = "umap", label = FALSE)
p1

## see how samples cluster on the UMAP
my.seurat <- SetIdent(my.seurat, value = "orig.ident")
p2 <- DimPlot(my.seurat, reduction = "umap", label = FALSE, repel = TRUE)
...
It's just a non-visual way to confirm that no clusters are sample-specific because that would indicate some artifact
